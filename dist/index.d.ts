...
export { showAlert, closeAlert, showPreloader, hidePreloader, showConfirm, acceptConfirm, cancelConfirm } from './redux/actions/modal-actions';
...
export { ShowAlertAction, CloseAlertAction, ShowPreloaderAction, HidePreloaderAction, ModalAction, RoutingAction, NavigateToAction, GoBackAction, ClearRoutingAction } from './redux/actions/framework7-actions';
